...
class TestSponsrProjectPage:
    def test_kinescope_links__extracted_from_post_html(self):
        ...
        assert SponsrPostPreview("", html).kinescope() == ["https://kinescope.io/90c1f6ae-2950-4f73-b99c-f2d0e88c93e2/master.mpd"]
    ...
    def test_kinescope_links__extracted_from_post_html__with_many_iframes(self):
        ...
        assert SponsrPostPreview("", html).kinescope() == [
            "https://kinescope.io/90c1f6ae-2950-4f73-b99c-f2d0e88c93e2/master.mpd",
            "https://kinescope.io/60c1f6ae-2950-4f73-b99c-f2d0e88c93e2/master.mpd"
        ]
